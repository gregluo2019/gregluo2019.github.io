        ...
        >
            ...
            <v-row dense no-gutters :style="screenWidthStyle">
              <v-col md="5">
                ...
                <transition name="fade">
                  ...
                  >
                    <b>
                      <span class="ml-9">Enquiry: greg.luo@outlook.com</span>
                      <br />
                      <span class="mr-4">WeChat: EasyManagement</span>
                      <span>Phone: 0406 518 207</span>
                    </b>
                  </span>
                </transition>
              </v-col>
          ...
          <span v-if="windowSize.x < 1400 && windowSize.x > 960">
            <v-row dense no-gutters :style="screenWidthStyle">
              ...
              <v-col :md="isScrolling ? 6 : 3" align="center" justify="center">
                <transition name="fade" class="pt-3">
                  <span
                    class="shadow3 text-h3 px-3"
                    :style="innokitNameStyles"
                    @click.stop="goto('/')"
                  >
                    {{ isScrolling ? "Easy Management" : "EasyMan" }}
                  </span>
                </transition>
            ...
            <v-footer padless dark>
              ...
              >
                <v-col align="center" cols="6">
                  <span class="py-2 white--text text-center">
                    <a class="no-decoration" href="/"> EASY MANAGEMENT </a>
                  </span>
                </v-col>
                ...
                <v-col align="center" cols="12">
                  ...
                  <span class="py-2 white--text text-center">
                    Address: 78-82 Jenkins Road, Carlingford NSW 2118
                  </span>
                </v-col>
                <v-col align="center" sm="12" class="mt-6">
                  <v-icon color="green"> mdi-whatsapp </v-icon>
                  <span class="py-2 white--text text-center">
                    WeChat微信: EasyManagement
                  </span>
                </v-col>
                <v-col align="center" cols="12">
                  <v-icon color="green"> mdi-email </v-icon>
                  <span class="py-2 white--text text-center">
                    greg.luo@outlook.com
                  </span>
                </v-col>
              </v-row>
              ...
              <v-row v-else justify="center" class="black py-9" no-gutters>
                <v-col align="center" sm="4">
                  <a class="no-decoration" href="/"> EASY MANAGEMENT SYDNEY </a>
                </v-col>
                <v-col align="center" sm="4">
                  <v-icon color="green"> mdi-phone </v-icon>
                ...
                <v-col align="center" sm="6" class="mt-6">
                  <v-icon color="green"> mdi-whatsapp </v-icon>
                  <span class="py-2 white--text text-center">
                    WeChat微信: EasyManagement
                  </span>
...
export default {
  ...
  created() {
    var num = 1 + Math.floor(Math.random() * 7); //1 + 0~6
